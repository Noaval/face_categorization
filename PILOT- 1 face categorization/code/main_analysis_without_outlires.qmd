...
write.csv(data_images_20, "data_images_20_all.csv", row.names = FALSE)
...
ggsave("plot_images_without_all.png", plot = plot_images, path = "../Plots_outliers/", width = 4000, height = 4000, units = "px")

```

![Overall trends per image by display](../Plots_outliers/plot_images_without_all.png)

### Responses and overall trends per image by display and *Order of conditions*

```{r}
#| code-fold: true

data_participants <- data_participants_without_all |>
...
ggsave("plot_images_order_condition_separated.png", plot = plot_image_condition,path = "../Plots_outliers/", width = 40, height = 40, units = "cm", bg = "white", limitsize = FALSE)

```

![Overall trends per image by display](../Plots_outliers/plot_images_order_condition_separated.png)
...
ggsave("plot1_without_all.png", plot = plot1, path = "../Plots_outliers/", width = 4000, height = 4000, units = "px")
...
![alt text: Overall trends per image by display,](../Plots_outliers/plot1_without_all.png)
...
participant_conditions <- data_participants_without_all |>
...
ggsave("plot_participants_without_all_label.png", plot = plot_participants_condLabel, path = "../Plots_outliers/", width = 4000, height = 4000, units = "px")
```

![alt text: Participants ratings](../Plots_outliers/plot_participants_without_all_label.png)
...
ggsave("plot_line_participants_without_All.png", plot = plot_participants_with_line, path = "../Plots_outliers/", width = 4000, height = 4000, units = "px")

```

![alt text: Participants ratings](../Plots_outliers/plot_line_participants_without_All.png)
...
#| code-fold: true
#| warning: false
#| label: Responses by display first
#| fig-cap: "Subjects responses by display first"
...
write.csv(ambiguous_images_comparison_df_20, "ambiguous_images_comparison_df_20.csv", row.names = FALSE)
```
...
ggsave("plot_images_without_all_first.png", plot = plot_images_first, path = "../Plots_first/", width = 4000, height = 4000, units = "px")

```

![Overall trends per image by display](../Plots_first/plot_images_without_all_first.png)
...
![alt text: Participants ratings](../Plots_first/plot_line_participants_without_All.png)

## Visual stimuli:

![](C:/Users\97252\Documents\GitHub\face_cater\PILOT-%201%20face%20categorization\Visual_stimuli\series%201.png) ![](C:/Users\97252\Documents\GitHub\face_cater\PILOT-%201%20face%20categorization\Visual_stimuli\series%202.png) ![](C:/Users\97252\Documents\GitHub\face_cater\PILOT-%201%20face%20categorization\Visual_stimuli\series%203.png)

![](C:/Users\97252\Documents\GitHub\face_cater\PILOT-%201%20face%20categorization\Visual_stimuli\series%204.png)

![](C:/Users\97252\Documents\GitHub\face_cater\PILOT-%201%20face%20categorization\Visual_stimuli\series%205.png)

![](C:/Users\97252\Documents\GitHub\face_cater\PILOT-%201%20face%20categorization\Visual_stimuli\series%206.png)

![](C:/Users\97252\Documents\GitHub\face_cater\PILOT-%201%20face%20categorization\Visual_stimuli\series%207.png)

![](C:/Users\97252\Documents\GitHub\face_cater\PILOT-%201%20face%20categorization\Visual_stimuli\series%208.png)
