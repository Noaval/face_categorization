...
### Difference of means per image by display with a cutoff of with a cutoff of *10* points difference between the ratings
...
data_images_big_diff_15 <- data_images |>
  dplyr::filter(abs(avg_diff) >= 15) |>
  mutate(rated_ethnicity = case_when(avg_diff < 0 ~ "Arab",
                                     avg_diff > 0 ~ "Jewish",
                                     .default = NA))
data_images_choosen_15 <- data_images |>
  dplyr::filter(abs(avg_diff)<15)|>
  mutate(rated_ethnicity = case_when(avg_diff < 0 ~ "Arab",
                                     avg_diff > 0 ~ "Jewish",
                                     .default = NA))
...
data_images_big_diff_20 <- data_images |>
  dplyr::filter(abs(avg_diff) >= 20) |>
  mutate(rated_ethnicity = case_when(avg_diff < 0 ~ "Arab",
                                     avg_diff > 0 ~ "Jewish",
                                     .default = NA))
data_images_choosen_20 <- data_images |>
  dplyr::filter(abs(avg_diff)<20)|>
  mutate(rated_ethnicity = case_when(avg_diff < 0 ~ "Arab",
                                     avg_diff > 0 ~ "Jewish",
                                     .default = NA))
...
# Adjusting data_images_choosen to consider the effect of condition order
...
ggsave("plot_images_with_all.png", plot = plot_images, path = "../Plots/", width = 4000, height = 4000, units = "px")
```
...
ggsave("plot_images_order_condition_separated.png", plot = plot_image_condition,path = "../Plots/", width = 40, height = 40, units = "cm", bg = "white", limitsize = FALSE)
...
ggsave("plot1_with_all.png", plot = plot1, path = "../Plots/", width = 4000, height = 4000, units = "px")
...
ggsave("plot_participants_with_all.png", plot = plot_participants, path = "../Plots/", width = 4000, height = 4000, units = "px")
```

![alt text: Participants ratings](images/plot.png)
```{r}

# Create a summary of the order of conditions for each participant
# Create a summary of the order of conditions for each participant with IDs
participant_conditions <- data_participants %>%
...
ggsave("plot_participants_with_all_label.png", plot = plot_participants_condLabel, path = "../Plots/", width = 4000, height = 4000, units = "px")
```
...
ggsave("plot_participants_with_line_all.png", plot = plot_participants_with_line, path = "../Plots/", width = 4000, height = 4000, units = "px")
