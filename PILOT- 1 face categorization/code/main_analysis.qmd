...
-   threshold is the cutoff value above which values are considered outliers (default is 3) Second option to pbtain the MAD MEDIAN ROLE for detecting outlires (better in my opinion) [link](https://statsandr.com/blog/outliers-detection-in-r/).
...
![Overall trends per image by display](../Plots/plot_images_with_all.png)
...
![Overall trends per image by display](../Plots/plot_images_order_condition_separated.png)
...
![alt text: Overall trends per image by display,](../Plots/plot1_with_all.png)
...
![alt text: Overall trends per image by display,](../Plots/plot_participants_with_all_label.png)
...
![alt text: Participants ratings with lines](../Plots/plot_participants_with_line_all.png) \## Demographics
